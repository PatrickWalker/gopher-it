...
Ok we're going to get a little more involved than we have so far. You now know more than enough that you can build some righteous Go stuff but most systems need some input to do interesting things so we're going to take a look at how to build some command line tools
...
Hello world but command line. Update the template below to take a single argument for name and print it out. World is a good default or you know a name of someone you love and respect (THE ROCK)

  | Name | Source | PlayGround |
|--|--|--|  
| Template | [source](exercises/hello-again/template/hello.go) | [pg](https://play.golang.org/p/Aa5_oUoVjxq) |
| Solution |[source](exercises/hello-again/solution/hello.go) | [pg](https://play.golang.org/p/vsIefmkZcmD) |
...
//this takes in an io.Reader as an argument
...
#### CSV Example
Good example in the go docs
[here](https://golang.org/pkg/encoding/csv/#example_Reader)

[Documented version](https://play.golang.org/p/YJjRomogUO-)

#### JSON Example 
This is a lovely feature of Golang which is the out of the box support for JSON. Marshalling and Unmarshalling Json to Structs is pretty easy and thanks to the tag mechanism is really readable
[Playground](https://play.golang.org/p/c-vPf4jyFRy)
Source code is available for that too [source](exercises/json/solution/json.go) 

### Reading keyboard input

You can also use bufio to read keyboard input because stdin, stderr and stdout are treated as open files
